    ...
    return CustomScrollView(
      slivers: [
        ...
        const SliverToBoxAdapter(
            child: Column(
          children: [
            RowSwitcherAndContainer(day: 'الأحد'),
            RowSwitcherAndContainer(day: 'الاُثنين'),
            RowSwitcherAndContainer(day: 'الثلاثاء'),
            RowSwitcherAndContainer(day: 'الأربعاء'),
            RowSwitcherAndContainer(day: 'الخميس'),
            SizedBox(
              height: 10,
            ),
          ],
