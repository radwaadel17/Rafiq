...
class _CountryViewBodyState extends State<CountryViewBody> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ResultCubit, ResultStates>(
      listener: (context, state) {
          ...
          Navigator.push(
            ...
            PageRouteBuilder(
              pageBuilder: (context, animation, secondaryAnimation) {
                return ResultView(
                  resultEntity: state.resultEntity,
                );
              },
              transitionsBuilder:
        ...
        } else if (state is ResultFailureState) {
          Flushbar(
      ...
      builder: (context, state) {
        return Stack(
          children: [
            ...
            CustomButtonQs(
              isLoading: state is ResultLoadingState,
              txt: 'توقــــع',
              onPressed: () {
                if (txt == null) {
                  Flushbar(
